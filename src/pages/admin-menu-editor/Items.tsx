...
const Subitems: FC<SubitemsProps> = ({ itemIndex, items, item, subitems, onOrderChange, itemExpand, onSelect, onHide, itemNew }) => {

	const [dragSubitemIndex, setDragSubitemIndex] = useState<{ subitemIndex: number | null }>({ subitemIndex: null });
	...
	return (
		<div className={`ozop-restrictions-submenu mt-2 ${itemExpand === item.url ? 'visible' : 'hidden'}`}>
...
const Items: FC<ItemsProps> = ({ items, onOrderChange, onSelect, onHide, itemExpand, onItemExpand, itemNew }) => {
